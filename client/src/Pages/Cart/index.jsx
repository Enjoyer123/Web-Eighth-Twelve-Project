...
const Cart = () => {
    ...
    const selectedItem = (item, quantityVal) => {
        ...
        if (chengeQuantity !== 0) {
            ...
            cartFields.catName = item?.catName
            cartFields.subCatName = item?.subCatName
                ...
                <p>There are <b className="text-red">{cartData?.length}</b> products in your cart</p>
                {
                    cartData?.length !== 0 ?
                            ...
                            <div className="col-md-3">
                                <div className="card border p-3 cartDetails">
                                    ...
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        {
                                            (cartData?.length !== 0 ?
                                                cartData?.map(item => parseInt(item.price) * item.quantity).reduce((total, value) => total + value, 0) : 0)?.toLocaleString('th-TH', { 
                                                    style: 'currency', 
                                                    currency: 'THB' 
                                                })
                                        }
                                    ...
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        <span className="ms-auto"><b>3-5 Business days</b></span>
                                    </div>
                        ...
                        <div className="empty d-flex align-items-center justify-content-center flex-column">
                            ...
                            <br />
                            <Link to="/"> <Button className='btn-blue bg-red btn-lg btn-big2 btn-round'>Continue Shopping</Button></Link>
                        </div>
