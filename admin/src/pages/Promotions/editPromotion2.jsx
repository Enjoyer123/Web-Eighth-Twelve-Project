...
import { fetchDataFromApi, postData, deleteData, uploadImage, deleteImages, editData } from '../../utils/api';
...
const EditPromotion2 = () => {
    ...
    useEffect(()=>{
        ...
        fetchDataFromApi(`/api/subdiscount/${id}`).then((res)=>{
          
           

            setcategoryVal(res.subCatName)
    ...
    const addSubCatDiscount = (e) => {
        ...
        if (formFields.discountPercentage !== -1 && formFields.subCatName !== "") {
            ...
            editData(`/api/subdiscount/${id}`, formFields).then((res) => {
