    ...
    return (
        <>
            <div className="right-content w-100">
                ...
                <form className='form' onSubmit={addOgDiscount}>
                    <div className='row'>
                        <div className='col card-big'>
                            <div className='card p-4'>

                                <div className='form-group'>
                                    <h6>original Discount</h6>
                                    <input type='number' name="ogDiscount" value={ogDiscount} onChange={changeInput2} />
                                </div>
                                ...
                                ><FaCloudUploadAlt /> &nbsp;  {isLoading2 === true ? <CircularProgress color="inherit" className="loader" /> : 'PUBLISH AND VIEW'}  </Button>
